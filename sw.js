const CACHE = 'domus-v5';   // D6: the vendor page   // bump on EVERY content change, and the .ver marker in index.html with it
...
// so the page still opens without signal. Static assets stay cache-first.
